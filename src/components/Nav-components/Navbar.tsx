        ...
        <div className="flex items-center gap-4 relative">
          ...
          <div className="lg:hidden">
            <details className="group">
              ...
              <ul className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md py-2 text-gray-700 font-medium group-open:scale-100 scale-0 transform origin-top-right transition-all duration-200">
